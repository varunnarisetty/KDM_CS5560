...
public class RecoResultActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		retriveFromDB(/*manager.getIngredientList()*/RecommendationList.selecteditem);
	...
	private void retriveFromDB(RecipeItem recipeName) {
		
		RetrievemPoseData retrive = new RetrievemPoseData();
		
		RecipeItem item = recipeName; //retrive.getRecipies(getApplicationContext(), recipeName);
		if(item == null){
